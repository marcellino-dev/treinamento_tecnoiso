...
export function TrainingLandingPage() {
  ...
  return <div className="min-h-screen overflow-hidden bg-white text-[#202020]">
    ...
    <main>
      {/* BANNER AJUSTADO PARA MOBILE - IMAGEM VISÍVEL */}
      <section id="inicio" className="relative min-h-[600px] overflow-hidden bg-[#28172f] text-white sm:min-h-[800px]">
        {/* IMAGEM: no mobile o object-position é "70% center" para deslocar o foco para o rosto do palestrante */}
        <img 
          src="/tecnoiso-speaker-hero.png" 
          alt="Palestrante em evento TECNOISO" 
          className="absolute inset-0 h-full w-full object-cover object-[70%_center] sm:object-center" 
        />
        
        {/* GRADIENTE: no mobile é mais escuro na esquerda para legibilidade, mas deixa a direita visível */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-[#170819]/95 via-[#210b22]/70 to-[#210b22]/30 sm:from-[#170819]/90 sm:via-[#210b22]/55 sm:to-transparent" />
